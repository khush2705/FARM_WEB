...
connection = sqlite3.connect("FarmWeb.db")
...
global welcome, mainpage, clogin, flogin, wlogin, farmer_dashboard, customer_register,article,cust_dashboard, main_page 

def statistics():
    welcome.destroy()
    global stats
    stats = Tk()
    stats.geometry("1280x690+150+100")
    stats.title("Statistics Window")
    stats.resizable(False, False)
    bg = ImageTk.PhotoImage(file=r"photos/Dash_Stat.jpg")
    ...
    titlec = Label(stats, text="Dashboard Statistics", pady=25, bg="#98DFED",
                   font=("Poppins", 26, "bold"),
                   fg="#1D2130").pack()
    photo = ImageTk.PhotoImage(file=r"photos/Statistics.jpg")
    back1 = Button(stats, cursor="hand2", command=demand_products, text="Demand of Products", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=152, y=125, width=225, height=225)
    back2 = Button(stats, cursor="hand2", command=supply_products, text="Supply of Products", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=402, y=125, width=225, height=225)
    back3 = Button(stats, cursor="hand2", command=VvsP_Purchased, text="Variety of Crops\nSold", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=652, y=125, width=225, height=225)
    back4 = Button(stats, cursor="hand2", command=VvsP_Inventory, text="Variety of Crops\nAvailable", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=902, y=125, width=225, height=225)
    back5 = Button(stats, cursor="hand2", command=districtVSfarmer, text="District Vs Farmers", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=152, y=375, width=225, height=225)
    back6 = Button(stats, cursor="hand2", command=districtVSworker, text="District Vs Workers", fg="black", image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=402, y=375, width=225, height=225)
    back7 = Button(stats, cursor="hand2", command=CustomerTypeDistribution, text="Customer Type\nDistribution", fg="black",
                  image=photo,
                  compound=TOP,
                  bg="white", font=("Poppins", 12, "bold")).place(x=652, y=375, width=225, height=225)
    back8 = Button(stats, cursor="hand2", command=back, text="Back",
                   fg="#ffffff",
                   compound=TOP,
                   bg="#2196F3", font=("Poppins", 12, "bold")).place(x=1080, y=610, width=150, height=60)
...
def welcome_page():
    global welcome
    welcome = Tk()
    welcome.geometry("1280x690+150+100")
    ...
    # === BB Image ======
    bg = ImageTk.PhotoImage(file=r"photos/Welcome.jpg")
    bg_image = Label(welcome, image=bg).place(x=0, y=0, relwidth=1, relheight=1)


    GetStarted_Button = Button(welcome, cursor="hand2", text="Get Started", bg="#FFFFFF",
                               command=lambda: main_page(), pady=57, padx=50, relief=RAISED,
                               font=("Poppins", 18)).place(x=390, y=275,height=60,width=200)
    stats = Button(welcome, cursor="hand2", text="Statistics", bg="#FFFFFF",
                               command=lambda: statistics(), pady=57, padx=53, relief=RAISED,
                               font=("Poppins", 18)).place(x=670, y=275,height=60,width=190)
...
def main_page():
    ...
    global mainpage
    mainpage = Tk()
    mainpage.geometry("1280x690+150+100")
    ...
    # === BB Image ======
    bg = ImageTk.PhotoImage(file=r"photos/bground.jpg")
    ...
    Frame_customer.place(x=165, y=220, height=250, width=250)
    titlec = Label(Frame_customer, text="Customer", font=("Poppins", 24, "bold"), bg="white",
    ...
    Loginc_Button = Button(Frame_customer, text="Login", cursor="hand2", command=lambda: customer_login(mainpage),
                           bg="#2196F3", fg="white", font=("Poppins", 14)).place(x=25, y=110,
                                                                                                    width=200, height=50)
    Registerc_Button = Button(Frame_customer, text="Registration", fg="white", cursor="hand2",
                              command=lambda: customer_register(mainpage),
                              bg="#2196F3", font=("Poppins", 14)).place(x=25, y=175, width=200, height=50)

    # ====Farmer Frame======
    Frame_Farmer = Frame(mainpage, bg="white")
    Frame_Farmer.place(x=515, y=220, height=250, width=250)
    titlef = Label(Frame_Farmer, text="Farmer", font=("Poppins", 24, "bold"), bg="white", fg="black", ).place(x=61, y=10)

    Loginf_Button = Button(Frame_Farmer, text="Login", cursor="hand2", bg="#2196F3",
                           command=lambda: farmer_login(mainpage),
                           fg="white", font=("Poppins", 14)).place(x=25, y=110, width=200, height=50)
    Registerf_Button = Button(Frame_Farmer, text="Registration", fg="white", cursor="hand2", bg="#2196F3",
                              command=lambda: farmer_register(mainpage),
                              font=("Poppins", 14)).place(x=25, y=175, width=200, height=50)

    # ====Worker Frame======
    Frame_Worker = Frame(mainpage, bg="white")
    Frame_Worker.place(x=865, y=220, height=250, width=250)
    titlew = Label(Frame_Worker, text="Worker", font=("Poppins", 24, "bold"), bg="white",
                   fg="black", ).place(x=62, y=10)
    Loginw_Button = Button(Frame_Worker, text="Login", cursor="hand2", bg="#2196F3",
                           command=lambda: worker_login(mainpage),
                           fg="white", font=("Poppins", 14)).place(x=25, y=110, width=200, height=50)
    Registerw_Button = Button(Frame_Worker, text="Registration", fg="white", cursor="hand2", bg="#2196F3",
    ...
    def Back():
        mainpage.destroy()
        welcome_page()
    back = Button(mainpage, cursor="hand2", command=Back, text="Back",bg="#2196F3", fg="#000000",compound=LEFT,
                        font=("Poppins", 18)).place(x=1090, y=615, width=170, height=55)
...
def customer_login(mainpage):
    ...
    clogin.configure(bg='yellow')
    clogin.resizable(True, True)
    # === BB Image ======
    bg = ImageTk.PhotoImage(file=r"photos/cust_login.jpg")
    #photo7 = ImageTk.PhotoImage(file=r"photos\back.png")
    ...
    forget_Button = Button(Frame_login, cursor="hand2", text="Forgot Password?", bg="white", bd=0, fg="#d77337",
    ...
    login_Button = Button(clogin, cursor="hand2",
                          ...
                          fg="#d77337", bd=9, bg="#FFE61B", font=("Book Antiqua", 22, "bold")).place(x=300, y=470, width=160, height=60)
    def back():
        clogin.destroy()
        welcome_page()
    back = Button(clogin, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1000, y=540, width=170, height=55)
    #login_Button = Button(clogin, cursor="hand2",
    #                      command=lambda: login_verify_customer(user_entry.get(), pass_entry.get()), text="Login",
    #                      fg="#d77337", bd=9, bg="#FFE61B", font=("Book Antiqua", 22, "bold")).place(x=1100, y=610, width=160, height=60)
...
def customer_register(mainpage):
    ...
    # Left Image
    left = ImageTk.PhotoImage(file=r"photos/reg page.jpg")
    ...
    register_butt = Button(main_frame, text="Register", bd=2, font=("times new roman", 15), cursor="hand2",
                           command=register, justify="center", bg="#9c103c", borderwidth=3)
    register_butt.place(x=430, y=390, width=120)

    # Login Button
    login_butt = Button(customer_register, text="Login", bd=3, font=("times new roman", 17), cursor="hand2",
                        command=lambda: customer_login(customer_register),
                        justify="center", bg="#9c103c", borderwidth=3)
    login_butt.place(x=220, y=500, width=120)
    def back():
        customer_register.destroy()
        welcome_page()
    back = Button(customer_register, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1150, y=640, width=170, height=55)
...
def farmer_register(mainpage):
    ...
    # Left Image
    left = ImageTk.PhotoImage(file=r"photos/test.jpg")
    ...
    # Submit Button
    register_butt = Button(main_frame, text="Register", bd=6, font=("times new roman", 15), cursor="hand2",
                           command=register, justify="center", bg="#9c103c", borderwidth=3)
    register_butt.place(x=430, y=390, width=120)

    # Login Button
    login_butt = Button(farmer_register, text="Login", bd=10, font=("times new roman", 17), cursor="hand2",
                        command=lambda: farmer_login(farmer_register),
                        justify="center", bg="#9c103c", borderwidth=3)
    login_butt.place(x=220, y=500, width=120)
    def back():
        farmer_register.destroy()
        welcome_page()
    back = Button(farmer_register, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1150, y=640, width=170, height=55)
...
def farmer_login(mainpage):
    ...
    flogin.resizable(True, True)
    # === BB Image ======
    bg = ImageTk.PhotoImage(file=r"photos/farmer_login.jpg")
    ...
    title = Label(Frame_login, text="Login Here", font=("Berlin Sans FB Demi", 35, "bold"), fg="#F0A500",
                  bg="white").place(x=120, y=30)
    desc = Label(Frame_login, text="Farmer Login Area", font=("Goudy old style", 15, "bold"), fg="#D4AC2B",
                 bg="white").place(x=145, y=100)
    ...
    forget_Button = Button(Frame_login, cursor="hand2", text="Forgot Password?", bg="white", bd=0, fg="#9D5C0D",
                            font=("times new roman", 15)).place(x=40, y=280)
    login_Button = Button(flogin, cursor="hand2",
                          command=lambda: login_verify_farmer(user_entry.get(), pass_entry.get()), text="Login",
                          fg="#FFCD00", bd=9, bg="#CF7500", font=("Cambria", 20,"bold")).place(x=320, y=470, width=150, height=50)
    def back():
        flogin.destroy()
        welcome_page()
    back = Button(flogin, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1000, y=540, width=170, height=55)
    flogin.mainloop()
...
def worker_register(mainpage):
    ...
    # Submit Button
    register_butt = Button(main_frame, text="Register", bd=4, font=("times new roman", 15), cursor="hand2",
                           command=register, justify="center", bg="#9c103c", borderwidth=3)
    register_butt.place(x=430, y=450, width=120)

    # Login Button
    login_butt = Button(worker_register, text="Login", bd=6, font=("times new roman", 17), cursor="hand2",
                        command=lambda: worker_login(worker_register),
                        justify="center", bg="#9c103c", borderwidth=3)
    login_butt.place(x=220, y=500, width=120)
    def back():
        worker_register.destroy()
        welcome_page()
    back = Button(worker_register, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1150, y=640, width=170, height=55)
...
def worker_login(mainpage):
    ...
    # === BB Image ======
    bg = ImageTk.PhotoImage(file=r"photos/worker-login.jpg")
    ...
    title = Label(Frame_login, text="Login Here", font=("Arial Black", 35, "bold"), fg="#3F0071",
                  bg="white").place(x=120, y=30)
    desc = Label(Frame_login, text="Worker Login Area", font=("Georgia", 15, "bold"), fg="#9A0680",
                 bg="white").place(x=145, y=100)
    ...
    login_Button = Button(wlogin, cursor="hand2",
                          ...
                          fg="#B42B51", bd=10, bg="#4C0027", font=("Cambria", 20, "bold")).place(x=330, y=470, width=160, height=53)
    def back():
        wlogin.destroy()
        welcome_page()
    back = Button(wlogin, cursor="hand2", command=back, text="Back", fg="#000000",bg="#2196F3",compound=LEFT,
                        font=("Poppins", 18)).place(x=1000, y=540, width=170, height=55)
    wlogin.mainloop()
...
def farmer_dashboard(flogin,username,article,welcome):
    ...
    farmer_dashboard = Tk()
    farmer_dashboard.title("Farmer Dashboard")

    farmer_dashboard.geometry("1300x700+100+50")
    farmer_dashboard.resizable(True, True)

    bg = ImageTk.PhotoImage(file=r"photos/Farmer_Dashboard.jpg")
    bg_image = Label(farmer_dashboard, image=bg).place(x=0, y=0, relheight=1, relwidth=1)

    def produce_for_sale():
        produceonline = Tk()
        produceonline.title("Inventory")
        produceonline.geometry("1300x700+100+50")
    ...
    def hired_workers():
        hiredowrkers = Tk()
        hiredowrkers.title("Hire History")
        hiredowrkers.geometry("1300x700+100+50")
    ...
    def farmer_upload():
        ...
        farmupload_window.title("Update Inventory")
        farmupload_window.geometry("1300x700+100+50")
        ...
        def farmer_upload_variety(e):
            ...
            insert_button = Button(farmupload_window, text="Insert Crop", command=insertcrop, cursor="hand2",
                                   bg="#2196F3", fg="white", font=("Poppins", 15)).place(x=350,
                                                                                                                  y=550,
                                                                                                                  width=150,
                                                                                                                  height=55)
        ...
        back = Button(farmupload_window, text="Back", command=lambda: farmupload_window.destroy(), cursor="hand2",
                      bg="#D3EAFD", fg="white", font=("Poppins", 15)).place(x=650,
                                                                                                     y=550,
                                                                                                     width=150,
                                                                                                     height=55)
        ...
        titlec = Label(farmupload_window, text="Input Product Information",pady=15, font=("Poppins", 24, "bold"),
                       fg="black" ).pack()
        l4 = Label(farmupload_window, text="select category",font=("Poppins", 15,"bold")).pack()
        Category_menu = ttk.Combobox(farmupload_window, state="readonly", value=categorylist)
        Category_menu.pack()

        l5 = Label(farmupload_window, text="select produce",font=("Poppins", 15, "bold")).pack()
        produce_menu = ttk.Combobox(farmupload_window, state="readonly")
        produce_menu.pack()

        l6 = Label(farmupload_window, text="select variety",font=("Poppins", 15,"bold")).pack()
        ...
        l2 = Label(farmupload_window, text="Enter Quantity", font=("Poppins", 15,"bold")).pack()

        quantity.pack()
        l3 = Label(farmupload_window, text="Enter rate per unit quantity",
                   font=("Poppins", 15,"bold")).pack()
    ...
    def farmer_hire():
        # farmer_dashboard.destroy()
        farmhirewindow = Tk()
        farmhirewindow.title("Hire Window")
        farmhirewindow.geometry("1300x700+100+50")
        ...
        def biodata_worker(e):
            ...
            # x = cursor.fetchall()
            # msg.config(text=x)
            hire = Button(farmhirewindow, cursor="hand2", text="Hire Worker", fg="White", bg="#2196F3",pady=5,
                          command=insert_worker,
                          font=("Poppins", 18)).place(x=520, y=550, width=180, height=55).pack()
        ...
        district_id = Label(farmhirewindow, text="Select District", font=("Poppins", 15),
                            fg="black").pack()
        district_menu = ttk.Combobox(farmhirewindow, state="readonly", value=distlist)
        district_menu.pack()

        city_id = Label(farmhirewindow, text="Select City", font=("Poppins", 15), fg="black")
        city_id.pack()
    ...
    def farmer_kit():
        # farmer_dashboard.destroy()
        farmerkit = Tk()
        farmerkit.title("Order Equipment")
        farmerkit.geometry("1300x700+100+50")
        category = StringVar()
        ...
        quantity.pack()
        buybutton = Button(farmerkit, text="Add to cart", command=addcart, cursor="hand2", bg="#2196F3",
                           fg="white", font=("Poppins", 15)).place(x=450,
                                                                                   y=550,
                                                                                   width=150,
                                                                                   height=55)
        ...
        back = Button(farmerkit, text="Back", command=lambda: farmerkit.destroy(), cursor="hand2",
                      bg="#D3EAFD", fg="white", font=("Poppins", 15)).place(x=700,
                                                                                                     y=550,
                                                                                                     width=150,
                                                                                                     height=55)
    ...
    def farmer_cart():
        ...
        # farmer_dashboard.destroy()
        farmercart = Tk()
        farmercart.title("Cart Window")
        farmercart.geometry("1300x700+100+50")
        ...
        totalcostlabel = Label(farmercart, text="Your total bill amount is ",pady=25,
                       font=("Poppins",15, "bold")).pack()
        cursor.execute('SELECT SUM(total_price) from farmer_cart')
        x = cursor.fetchall()
        totalcostlabel2 = Label(farmercart, text=x,pady=10,
                       font=("Poppins",15, "bold"))
        totalcostlabel2.pack()

        buynow = Button(farmercart, cursor="hand2", command=buy_now, text="Buy Now", fg="white", bg="#2196F3",
                        font=("Poppins", 18)).place(x=505, y=400,width=180, height=55)
        buynow.pack()

    photo1 = ImageTk.PhotoImage(file=r"photos/my market.png")
    photo2 = ImageTk.PhotoImage(file=r"photos/kit.png")
    photo3 = ImageTk.PhotoImage(file=r"photos/my cart.png")
    photo4 = ImageTk.PhotoImage(file=r"photos/worker.jpg")
    photo5 = ImageTk.PhotoImage(file=r"photos/article.png")
    photo6 = ImageTk.PhotoImage(file=r"photos/Statistics.jpg")
    photo7 = ImageTk.PhotoImage(file=r"photos/back.png")
    market_upload = Button(farmer_dashboard, cursor="hand2", text=" Market", command=farmer_upload, fg="black",
                           bg="white",image=photo1,compound=LEFT,pady=10,
                           font=("Poppins", 18)).place(x=320, y=10, width=190, height=50)
    kit_buy = Button(farmer_dashboard, cursor="hand2", text="  Kit", fg="black", bg="white",image=photo2,compound=LEFT,pady=10, command=farmer_kit,
                     font=("Poppins", 18)).place(x=510, y=10, width=190, height=50)
    cart = Button(farmer_dashboard, cursor="hand2", text="   Cart", fg="black", bg="white",image=photo3,compound=LEFT,pady=10, command=farmer_cart,
                  font=("Poppins", 18)).place(x=700, y=10, width=190, height=50)
    hire = Button(farmer_dashboard, cursor="hand2", text="   Hire", fg="black",bg="white", image=photo4,compound=LEFT,pady=10,command=farmer_hire,
                  font=("Poppins", 18)).place(x=890, y=10, width=190, height=50)
    article = Button(farmer_dashboard, cursor="hand2", text="Article", fg="black", bg="white", image=photo5, compound=LEFT,command=article,
                  pady=10,
                  font=("Poppins", 18)).place(x=130, y=10, width=190, height=50)
    history = Button(farmer_dashboard, cursor="hand2", text="My Crops", fg="#ffffff", bg="#2196F3", command=produce_for_sale,
                     font=("Poppins", 18)).place(x=410, y=500, width=190, height=60)
    history1 = Button(farmer_dashboard, cursor="hand2", text="Hired Workers", fg="#ffffff", bg="#2196F3",
                     command=hired_workers,
                     font=("Poppins", 18)).place(x=620, y=500, width=210, height=60)
    def logout():
        farmer_dashboard.destroy()
        welcome()

    back = Button(farmer_dashboard, cursor="hand2", command=logout, text="Log Out", fg="#000000",image=photo7,compound=LEFT,
                         bg="white",font=("Poppins", 18)).place(x=1100, y=650, width=170, height=55)
...
def worker_dashboard(wlogin, username,article,welcome):
    ...
    worker_dashboard = Tk()
    worker_dashboard.title("Worker Dashboard")

    worker_dashboard.geometry("1300x700+100+50")
    worker_dashboard.resizable(True, True)
    ...
    def bio():
        ...
        bio_window = Tk()
        bio_window.title("BioData Window")
        bio_window.geometry("600x400+100+50")
        bio = Label(bio_window, text="Enter Bio Data", font=("Poppins", 24, "bold"), bg="white", fg="black")
        bio.place(x=200, y=10)
        entry_bio = Text(bio_window, font=("Poppins", 15), borderwidth=2, bg="white")
        entry_bio.place(x=125, y=70, width=350, height=180)
        submit = Button(bio_window, cursor="hand2", text="Submit", fg="White", bg="#2196F3", command=insert_bio,
                        font=("Poppins", 18)).place(x=200, y=280, width=190, height=50)

    def status():
        status_window = Tk()
        status_window.title("Status Window")
        ...
        if status == 1:
            ...
            v = "Not Hired Yet😞"
        info_label = Label(status_window, text=v, font=("Poppins", 18, "bold"), fg="black").place(
            x=140, y=25)
        submit = Button(status_window, cursor="hand2", text="OK", fg="black", bg="#2196F3", command=exit,
                        font=("Poppins", 18)).place(x=230, y=180, width=190, height=50)

    bg = ImageTk.PhotoImage(file=r"photos/work_db.jpg")
    ...
    photo7 = ImageTk.PhotoImage(file=r"photos/back.png")
    BioData = Button(worker_dashboard, cursor="hand2", text="Enter Bio Data", fg="white", bg="#2196F3", command=bio,
                     font=("Poppins", 18)).place(x=385, y=500, width=210, height=65)
    Status = Button(worker_dashboard, cursor="hand2", text="Check Status", fg="white", bg="#2196F3", command=status,
                    font=("Poppins", 18)).place(x=685, y=500, width=210, height=65)
    article = Button(worker_dashboard, cursor="hand2", text="  Article", fg="black", bg="white",
                     image=photo5, compound=LEFT, command=article,
                     pady=10, font=("poppins", 18)).place(x=520, y=40, width=190, height=50)
    ...
    back = Button(worker_dashboard, cursor="hand2", command=logout, text="Log Out", fg="black",image=photo7,compound=LEFT,
                         bg="white",font=("Poppins", 18)).place(x=0, y=650, width=160, height=55)
...
def customer_dashboard(clogin,username,article,welcome):
    ...
    cust_dashboard = Tk()
    cust_dashboard.title("Customer Dashboard")

    cust_dashboard.geometry("1199x700+100+50")
    cust_dashboard.resizable(False, False)
    
    bg = ImageTk.PhotoImage(file=r"photos/cust_db.jpg")
    ...
    def cust_buy():
        ...
        quantity.pack()
        buybutton = Button(custbuy, text="Add to cart", command=customer_addcart, cursor="hand2", bg="#FFB72B",
                           bd=10,pady=5,
                           fg="black", font=("Georgia", 15, "bold")).place(x=420,y=600)
        produce_menu.bind("<<ComboboxSelected>>", prodpicked)
        Category_menu.bind("<<ComboboxSelected>>", catpicked)
    ...
    def customer_cart():
        ...
        buynow = Button(customercart, cursor="hand2", command=buy_now, text="Buy Now", fg="black", bg="orange",bd=10,font=("arial black", 18)).place(x=525,y=350,width=155,height=55)
        buynow.pack()

    def customer_history():
        customerhistory = Tk()
        customerhistory.title("Order History")
        ...
        titlec = Label(customerhistory, text="Your Orders", pady=10,
                       font=("Berlin Sans FB Demi", 28, "bold"),
                       fg="black").pack()
        ...
        display.pack()
        buynow = Button(customerhistory, cursor="hand2", command=back, text="Back", fg="#0A043C", bg="#D89216",bd=8,
                        font=("times new roman", 22,"bold")).place(x=510,y=380,width=155,height=50)
    ...
    customer_buy = Button(cust_dashboard, cursor="hand2", text="  Market", command=cust_buy, fg="black",
                          bg="white", image=photo1, compound=LEFT, pady=10, font=("Poppins", 18)).place(x=510, y=20, width=190, height=50)

    cart = Button(cust_dashboard, cursor="hand2", command=customer_cart, text="  Cart", fg="black", bg="white",image=photo3, compound=LEFT,
                  pady=10,font=("Poppins", 18)).place(x=700, y=20, width=190, height=50)

    article = Button(cust_dashboard, cursor="hand2",  text="  Article", fg="black", bg="white",
                  image=photo5, compound=LEFT,command=article,
                  pady=10, font=("Poppins", 18)).place(x=320, y=20, width=190, height=50)


    past_orders = Button(cust_dashboard, cursor="hand2", command=customer_history, text="Order History", fg="#ffffff",
                         bg="#2196F3",
                         font=("Poppins", 20)).place(x=490, y=500, width=190, height=60)


    back = Button(cust_dashboard, cursor="hand2", command=logout, text="Log Out", fg="#3F0713",image=photo7,compound=LEFT,
                         bg="white",font=("Poppins", 18)).place(x=0, y=650, width=160, height=55)
